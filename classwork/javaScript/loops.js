...
//   guess = parseInt(prompt("Guess the correct number!"));
// }

// alert(`You are correct! The number is ${guess}`);
// let input;
// do {
//   input = parseInt(prompt("Enter a number greater than 5:"));
// } while (input <= 5);
...
//     capital:
//       "Pretoria (admin), Cape Town (legislative), Bloemfontein (judicial)",
//   },
...
// countriesWithCapitals.map((country, index) => {
//   return console.log(`${country.country}: ${country.capital}`);
// });
